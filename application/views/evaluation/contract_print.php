...
<div class="pdf-wrapper">
    <div class="pdf-header">
		...
		<div class="pull-right" style="float: right; width: 20%;">
            <img class="images" src="<?php echo $contract['avatar'] ?>"/>
            <img class="images" src="<?php echo $contract['contract_avatar'] ?>"/>
            <img class="images" src="<?php echo $contract['image'] ?>"/>
            <img class="images" src="<?php echo $contract['employee_avatar'] ?>"/>
