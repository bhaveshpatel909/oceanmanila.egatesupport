<?php $this->load->view('layout/header', array('title' => $this->lang->line('Accounting Calendar'), 'forms' => TRUE, 'tables' => TRUE, 'icheck' => TRUE, 'magicsuggest' => TRUE)) ?>
<style>
.schedule-popover{
	right:0px;
	top:22px;
...
#updateeee{display:none!important;}
#uptimeee{display:none!important;}
...
<?php } ?>
 ...
 return JSON.parse($.ajax({
     type: 'GET',
     url: 'schedule/accountingcalendar',
     dataType: 'json',
     global: false,
     async:false,
     success: function(data) {
...
<div id="wrapper">
    <?php $this->load->view('layout/menu', array('active_menu' => 'schedule_accounting_calendar')) ?>
    ...
    $('document').ready(function () {
		$(document).on('click', '.abc', function(){
			...
			window.location.href = burl+"schedule/new_accounts_schedule/?selected="+vall;
		 });
          ...
          //alert(dddd);
		   //	window.location.href = "http://wshrms.peza.com.ph/schedule/newbitform_entry/?selected="+dddd;
            //}
        }); 
	});
		...
		if(isset($message)){
            ...
            <div class="col-lg-3">
                <h2><?= $this->lang->line('Accounting Calendar') ?></h2>
                <ol class="breadcrumb">
                    <li>
                        <a href="dashboard"><?= $this->lang->line('Home') ?></a>
                    </li>
                    <li>
                        <?= $this->lang->line('Accounting Calendar') ?>
                    </li>
                </ol>
            </div>
            <!--div class="col-lg-2">
            ...
            <div class="col-lg-4">
                <div class="title-action" style ="">                    
                    <a href="schedule/new_accounts_schedule" class="btn btn-primary">
