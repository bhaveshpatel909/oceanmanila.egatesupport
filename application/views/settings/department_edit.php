    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="settings/delete_department" method="POST" id="delete_department">
                    <input type="hidden" id="department_id" name="department_id" value="<?= $department['department_id']?>" class="department_id">
                </form>
                            ...
                            <div class="tab-pane fade active in" id="department_tab">
                                <div class="col-lg-6" style="padding-left: 0;">
                                    <div class="form-group has-feedback m-t-sm">
                                        ...
                                        <input type="text" name="department_name" id="department_name" class="form-control required" maxlength="100" value="<?= $department['department_name']?>">
                                    </div>
                                </div>
<!--                                <div class="col-lg-6">
...
<!--                            <div class="tab-pane fade" id="skills_tab">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger pull-left" onclick="confirm('Delete department ?') && submit_form('#delete_department','#save_result2')"><?= $this->lang->line('Delete')?></button>
