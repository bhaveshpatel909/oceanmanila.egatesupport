        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="settings/save_request" method="POST" id="save_request">
                    ...
                    <input type="hidden" id="request_id" name="request_id" value="0" class="request_id">
                        ...
                        <div class="tab-pane fade active in" id="request_tab">
                            <div class="col-lg-6" style="padding-left: 0;">
                                <div class="form-group has-feedback m-t-sm">
                                    <label for="request" class="control-label"><?= $this->lang->line('Request name')?><sup class="mandatory">*</sup></label>
                                    <input type="text" name="request_name" id="request_name" class="form-control required" maxlength="100">
                                </div>
                            </div>
<!--                            <div class="col-lg-6">
                                <div class="form-group has-feedback m-t-sm m-b-none">
                                    ...
                                    <select name="department_id" id="department_id" class="form-control required">
                                        ...
                                        <option value="<?= $request['request_id']?>"><?= $request['request_name']?></option>
                                        <?php }?>
                                    </select>
                                </div>
