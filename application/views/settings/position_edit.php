    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="settings/delete_position" method="POST" id="delete_position">
                    <input type="hidden" id="position_id" name="position_id" value="<?= $position['position_id']?>" class="position_id">
                </form>
                <form action="settings/save_position" method="POST" id="save_position">
                    <div id="save_result2"></div>
                        ...
                        <ul class="nav nav-tabs">
                          <li class="active"><a href="#position_tab" data-toggle="tab"><?= $this->lang->line('Position')?></a></li>
                          <!--<li><a href="#skills_tab" data-toggle="tab"><?= $this->lang->line('Required skills')?></a></li>-->
                        </ul>
                        
                        <div class="tab-content">
                            <div class="tab-pane fade active in" id="position_tab">
                                <div class="col-lg-6" style="padding-left: 0;">
                                    <div class="form-group has-feedback m-t-sm">
                                        ...
                                        <input type="text" name="position_name" id="position_name" class="form-control required" maxlength="100" value="<?= $position['position_name']?>">
                                    </div>
                                </div>
<!--                                <div class="col-lg-6">
                                    <div class="form-group has-feedback m-t-sm m-b-none">
                                        ...
                                        <select name="department_id" id="department_id" class="form-control required">
                                            ...
                                            <option <?= ($department['department_id']==$position['department_id'])?'selected="selected"':''?> value="<?= $department['department_id']?>"><?= $department['department_name']?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <div class="checkbox i-checks m-b-none">
                                            <input type="checkbox" name="is_head" id="is_head" <?= ($position['is_head']=='1')?'checked="checked"':''?> class="i-checks">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="6" id="responsibilities" name="responsibilities" class="form-control"><?= $position['responsibilities']?></textarea>
                                </div>
                            </div>
<!--                            <div class="tab-pane fade" id="skills_tab">
                                    ...
                                    <?php foreach($skills as $categories){?>
                                        <li>
                                            ...
                                            <ul class="unstyled">
                                                ...
                                                <li>
                                                    <div class="checkbox i-checks m-b-none">
                                                        <input type="checkbox" name="skills[<?= $skill['skill_id']?>]" id="skill_<?= $skill['skill_id']?>" <?= (is_null($skill['position_id']))?'':'checked="checked"'?> class="i-checks">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger pull-left" onclick="confirm('Delete position ?') && submit_form('#delete_position','#save_result2')"><?= $this->lang->line('Delete')?></button>
