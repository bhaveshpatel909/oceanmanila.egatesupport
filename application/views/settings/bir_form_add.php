<?php if (is_numeric($result)){
    ...
    <script>
        $('document').ready(function(){
            row = current_table.fnAddData([$("#form_name").val(),$("#due_date").val(),'<a href="settings/edit_bir_form/<?= $result?>" data-target="#modal_window" data-toggle="modal" class="btn btn-outline btn-success"><i class="fa fa-edit"></i></a>']);
