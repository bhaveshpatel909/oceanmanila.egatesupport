...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                <h2><?= $this->lang->line('Request Category List')?><span><img title="-Register and add additional specific request list that will be added to the
Request category list that will be easily selected" style="margin-left:5px;margin-right:5px;" src="images/if_Help.png" width="17px"></span> </h2>
                <ol class="breadcrumb">
                    <li>
