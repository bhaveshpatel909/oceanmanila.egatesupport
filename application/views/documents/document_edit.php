...
<!--                        <label class="control-label" for="description"><?= $this->lang->line('Document')?></label>
                    ...
                    <div class="form-group">
                        ...
                        <select name="document_category_id" id="document_category_id" class="form-control required">
                            ...
                            <?php foreach ($categories as $category) { ?>
                                <option <?php echo ($document['document_category_id'] == $category['document_category_id'])? 'selected' : ''?> value="<?= $category['document_category_id'] ?>"><?= $category['document_category_name'] ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="form-group">
				...
				<div class="form-group">
                       <label for="for_themonth" class="control-label"><?= $this->lang->line('Date Reminder') ?></label>
                            <input type="text" name="date_reminder" id="date_reminder"  value ="<?php if($document['date_reminder']!= '0000-00-00 00:00:00'){echo $document['date_reminder'];}?>"class="form-control datetimepicker" data-date-format="<?= $this->config->item('js_month_format') ?>">
                    </div>
					<div class="form-group">
                       <label for="for_themonth" class="control-label"><?= $this->lang->line('Email For Reminder') ?></label>
                            <input type="checkbox" <?php if($document['email_for_reminder']==1){echo "checked=checked";}?> name="email_for_reminder" id="email_for_reminder" class="form-control " value="1">
                    </div>
                    <div class="form-group">
