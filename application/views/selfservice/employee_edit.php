...
$pre_url =$_SERVER['HTTP_REFERER'];
 ...
 -->
										...
										<div class="col-md-5 col-sm-5 ccd">
										<div class="row">
											<div class="col-md-6 col-sm-6 ">
										<!-- <div class="ibox-title">
                                    <h5><?//= $this->lang->line('Details') ?>
...
<div class="ibox-content no-padding border-left-right text-center" title="Picture should be lasted Photo with good resulution . It will also used for company ID Picture , Do not use picture from resume.  Take picture using phone application.">   
 <?php if($employee['avatar']){ ?>                         
                                            <img class="avatar img-rounded " src="<?= $employee['avatar'] ?>" style="width: 140px;height: 140px; margin: 20px 0; margin-left:16px;" data-toggle="modal" data-target="#myModal">
 <?php }
 else
 {
	 ?>
	  <img class="avatar img-rounded " src="files/avatars/blank-person.jpg" style="width: 140px;height: 140px; margin: 20px 0; margin-left:16px;" data-toggle="modal" data-target="#myModal">
	 <?php
	 }
 ?>
                                            <!-- imgSelect Container -->
									...
									<div class="col-md-6 col-sm-6 sper-div">
											<!--<div class="ibox-title">
                                    <h5>	<label for="sign_image" class="control-label"><?//= $this->lang->line('Signature Image') ?></label></h5>
                                </div>-->
<div class="ibox-content no-padding border-left-right text-center  data-1" title="Picture should be lasted Photo with good resulution . It will also used for company ID Picture , Do not use picture from resume.  Take picture using phone application.">    
										...
										<div class="col-md-2 col-sm-2 cstmcls">										
										   <?php if ($employee['is_active'] == 1) { ?>
                                                <span style="display:none;"class="badge badge-success m-t-xs" id="employee_status"><?= $this->lang->line('Active') ?></span>
                                            <?php } else { ?>
									...
									<?php foreach ($positions as $position) { 
												   ...
												   {
													   ?><span class="b-1" style="color:#ff0000;">
													       <span class="d-3">Position:</span>
													   <?php
									...
									{
									?>
									<span class="b-2" style="color:#ff0000;">
										    <span class="d-2">Position:</span>
...
<?php									
									...
									{
										?>
										<span class="b-3"style="color:#ff0000;">
										    <span class="d-1">Department:</span>
									...
									?>
									<span class="b-2" style="color:#ff0000;">
										    <span class="d-2">Department:</span>
									...
									<table class="tablesty table table-striped table-bordered table-hover data_table" >
										...
										<tbody class="fbody">
											...
											<tr entity_id="<?= $evaluation['evaluation_id']; ?>">
												...
												<td class="prw">
			<a target="_blank" title="preview" type="application/pdf" class="btn btn-outline btn-primary btn-xs" href="evaluation/preview_evaluation/<?= $evaluation['evaluation_id']?>" download="<?php echo base_url('files/attachments/' . $attachment['file']) ?>" target="_blank">
                                                <i class="fa fa-file-pdf-o"></i>
                                            </a>
											<a class="btn btn-outline btn-primary btn-xs" href="javascript:void(0);" onclick="msend_evaluation(<?php echo $evaluation['evaluation_id'];?>)">
												<img src="<?php echo base_url();?>/images/email-icon.png " style="width:15px; height:10px; border-radius:2px;"></a>	</td>
