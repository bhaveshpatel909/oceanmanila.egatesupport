...
<div class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li style="display:none;"><a href="#permissions_tab" data-toggle="tab"><?= $this->lang->line('Permissions')?></a></li>
                    <li><a href="#temp_permissions_tab" data-toggle="tab"><?= $this->lang->line('Permissions')?></a></li>
                </ul>
                ...
                <form action="employees/save_password" method="POST" id="save_password">
                    <div class="tab-content">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
                                <div class="checkbox i-checks m-b-none">
								<label for="is_active" class="control-label"><?= $this->lang->line('Employee Status Note - Separation Date')?></label>
 ...
 // echo '<pre>';
                            ...
                            <?php foreach($this->config->item('possible_permissions') as $key=>$perm){
								...
								?>
								<h3 style ="color:orange;"><?php echo $key;?>
								<hr  style ="color:orange!important;border-top: 1px solid orange!important;margin-top: 5px;margin-bottom: 11px;"></hr></h3>
...
.modal-footer{ margin-top:0px;}
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default"  id ="acc_pop" data-dismiss="modal"><?= $this->lang->line('Close')?></button>
