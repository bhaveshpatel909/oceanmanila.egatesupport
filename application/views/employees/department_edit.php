    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="employees/delete_department" method="POST" id="delete_department">
                    <input type="hidden" id="department_id" name="department_id" value="<?= $data['id']?>" class="department_id">
                </form>
                <form action="employees/save_department" method="POST" id="save_department" role="form">
                    ...
                    <div class="form-group has-feedback">
                        <label for="institution_name" class="control-label"><?= $this->lang->line('Institution')?><sup class="mandatory">*</sup></label>
