               ...
               <form action="employees/delete_emp" method="POST" id="delete_employee_memo">
				...
				<?php
					//$gidss= $_GET['page'];
						  ...
						  //if($emp_memo['employee_id']==$gidss ){
					?>
                    <input type="hidden" id="employee_memo_id" name="employee_memo_id" value="<?php echo $emp_memo['employee_id'] ?>" class="contract_type_id">
					<?php //}
							//} ?>
                </form>
                <form action="employees/save_employee_memoo" method="POST" id="up_employee_memo">
                   <div id="save_result2"></div>
					...
					//$gidss= $_GET['page'];
						 ...
						 // if($emp_memo['employee_id']==$gidss ){
					?>
                    <!--<input type="hidden" id="employee_memo_id" name="employee_memo_id" value="<//?php echo $emp_memo['employee_id'] ?>" class="employee_memo_id">-->
