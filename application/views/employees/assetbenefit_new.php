        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="employees/save_assetbenefit" method="POST" id="save_assetbenefit">
                    ...
                    <input type="hidden" id="assetbenefit_id" name="assetbenefit_id" value="0" class="assetbenefit_id">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="assetbenefit_name" id="assetbenefit_name" class="form-control required" maxlength="100">
                    </div>
					<div class="form-group">
                        <label for="assetbenefit_name" class="control-label"><?= $this->lang->line('Returned')?></label>
                        <input type="checkbox" name="assetbenefit_check" id="assetbenefit_check" class="form-control " value ="1">
                    </div>
