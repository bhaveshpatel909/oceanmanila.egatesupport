<?php $this->load->view('layout/header',array('title'=> 'processcallingcardnew','forms'=>TRUE, 'tables' => TRUE,'scroll'=>TRUE,'icheck'=>TRUE,'magicsuggest'=>TRUE)) ?>
<script>
			...
			"aoColumns": [
               ...
               {"bSortable": false, "mRender": checkbox},{"bSortable": true, "mRender":  function ( data, type, row )
						...
						}},{"bSortable": true, "mRender":  function ( data, type, row )
						{
							...
							var diffInMs   = new Date() - new Date(From_date)
						...
						}},{"bSortable": false, "mRender":  function ( data, type, row )
						{
							...
							//$('#myModal img').attr('src',s_url+row[2]);
							var  cl12_data ='<img class="avatar img-rounded " src="'+s_url+row[2]+'" style="width: 50px;height: 50px; margin: 3px 0;border-radius: 2px!important;" data-toggle="modal" data-target="#myModal"><input type="hidden" value="'+row[0]+'" name="emp_id"> ';
							return cl12_data;
						}},{"bSortable": true, "mRender":  function ( data, type, row )
						{
							// var days =0;
						...
						// var  diffInDays = Math.floor(diffInMs / (1000 * 60 * 60 * 24));
							...
							// else
							// {
							// var cl7_data ='<span id ="emp_r_d_'+row[0]+'">'+diffInDays+'</span><p  id="hov_rem_text_'+row[0]+'"  class ="hov_rem_con" style="display:none">Contract Remaining Days</p>';
							// }
							//return cl7_data;
...
.new_bt {float: left; }
.decd {float: left;  width: auto; border: 1px solid #bbb;padding: 4px 6px 4px 6px;
...
.dataTables_wrapper table th:nth-child(5) {min-width: 59px; display:none!important;}
...
.dataTables_wrapper table td:nth-child(17) 
{    display:none!important;
}.dataTables_wrapper table th:nth-child(18) 
{ 
 display:none!important;
}.dataTables_wrapper table th:nth-child(17) 
{ 
...
.dataTables_wrapper table td:nth-child(18) 
{    display:none!important;
...
.dataTables_wrapper table td:nth-child(28) 
{   min-width: 250px !important;

}

.dataTables_wrapper table th:nth-child(28) 
...
.my-slect select {border-radius:2px!important;}

</style>

<div id="wrapper">
    <?php $this->load->view('layout/menu',array('active_menu'=>'processcallingcardnew'))?>
            ...
            <div class="col-lg-12 col-sm-12">
			    <div class="row">
					<div class="col-lg-1 col-sm-12">
						<h2><?php echo "Employee List"?></h2>
						<ol style="display:none;"class="breadcrumb">
							<li>
								<a href="dashboard"><?= $this->lang->line('Home')?></a>
							</li>
							<li>
								<?php echo "Process Id & calling card";?>
							</li>
						</ol>
					</div>

					<div class="col-lg-11 col-sm-12 alignment22">	
						...
						<div class="view_sece view_sece222">
							<a href="employees/outputCSVwithexp" id="new_view11" title="You Can Download Employee Data with  contract expiration date Here" value="checked"><i class="fa fa-download"> </i> Download with Expiration </a>
						</div>
						<div class="col-lg-1">
							<div class="title-action" style="padding-top:11px; text-align:left;">
            ...
            <div class="col-lg-12">
                ...
                <div class="wrapper wrapper-content animated fadeInDown">
                    <div class="ibox-content">
						...
						<div class="col-md-1" style="float: right; margin-right: 0px;"><div class="my-slect new-slect-3">
							 <select name="hiring_status_id" id="hiring_status_id" class="form-control required" style="border-radius:2px!important;">
						...
						<div class="col-md-1" style="float: right; margin-right: 0px;"><div class="my-slect my-slect new-my-2">
                            <select name="group_id" id="group_id" class="form-control required" style="border-radius:2px!important;">
											...
											<div class="col-md-1" style="float: right; margin-right: 0px;">
												<div class="my-slect new-my-1">
													<select name="department_id" id="department_id" class="form-control required"style="border-radius:2px!important;">
											...
											<div class="col-md-1" style="float: right; margin-right: 0px;">
												<div class="my-slect new-my">
												 <select name="rem-day-filter" id="rem-day-filter" class="form-control required"style="border-radius:2px!important;">
											...
											<div class="col-md-1" style="float: right; width:100px; margin-right: 0px;">
												<div class="my-slect">
													Active <input type ="checkbox"  name ="check_active_inactive"  id ="check_active_inactive" value ="1" checked="checked">
												</div>
											</div>
                                        ...
                                        <th style="width:50px!important;" style="">Reg/N-Reg</th>
										...
										<th style="width:50px!important;">	<img title="You Can Reset All Employee Confirmed Date From Here" class="reset_con" style=" vertical-align: top; width: 18px;    margin-right:4px;    margin-left: 3px;    margin-top: 0px;    float: left;" 
										 ...
										 <th><?= $this->lang->line('PIC') ?></th>
										  ...
										  <th  class="surname" style="text-align:left;">Surname</th>
											
										 <th style="width:50px!important;"><?= $this->lang->line('D-Hired ( Month )') ?></th>
										 <th title="Working Days" style="width:50px!important;">W-days</th>
										  
                                        <th><?= $this->lang->line('Department') ?></th> 
                                        <th class="group-22"><?= $this->lang->line('Group') ?></th> 
...
.confirmwrap23456789{ width:165px;}	
  ...
  <p  title="You Can Delete All Copy Signature Images from  Here">
    ...
    float: left;"    src="<?php echo base_url();?>files/logo/delete_png.png"></p>
										...
										<th style="width:5%;"><?= $this->lang->line('Email') ?></th>
...
.modal-body.pop_up_img img.avatar.img-rounded {
    width: 400px;
}
...
div#data_table_wrapper > .row {
    width: 14%;
}
.my-slect.new-my select#rem-day-filter {
    width: 70%;
    position: relative;
    left: -6%;
}
...
.new-my-2 select#group_id {
    width: 54%;
    z-index: 999999!important;
    margin-right: 0px !IMPORTANT;
}
.my-slect.new-slect-3 {
...
table#data_table th:nth-child(24) {
    min-width: 84px;
}
.dataTables_wrapper table td:nth-child(11) {
    min-width: 87px;
...
table#data_table thead tr th:nth-child(5) {
    background: none !important;
}
table#data_table thead tr th.sorting_disabled {
    background: none;
}
</style>
...
<!--div class="show22">
  ...
  <div class="img-show">
   ...
   <!-- Modal -->
   <div class="modal fade" id="myModal" role="dialog"><div class="pop23456"> <div class="pop234"><div class="modal-dialog modal-sm "><div class="modal-content ">  <div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button> </div><div class="modal-body pop_up_img" style=""> <img class="avatar img-rounded" src="" ></div> </div> </div> </div> </div></div>
