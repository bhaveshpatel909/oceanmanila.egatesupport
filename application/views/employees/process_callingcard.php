			...
			"aoColumns": [
               ...
               {"bSortable": false, "mRender": checkbox},{"bSortable": false, "mRender":  function ( data, type, row )
						...
						}},{"bSortable": true, "mRender":  function ( data, type, row )
						{
							...
							{
							var cl7_data ='<span id ="emp_r_d_'+row[0]+'">'+days+'</span><p  id="hov_rem_text_'+row[0]+'"  class ="hov_rem_con" style="display:none">Contract Remaining Days</p>';
							}
							return cl7_data;
						}},{"bSortable": true, "mRender":  function ( data, type, row )
						{
...
<button id="emaill" title="Send email to all employee for data confirmation">Email to all</button>
			...
			<div class="col-lgg-6" style="float:right;margin:0px 20px;">
			<div class="row">			
		  	<div class="col-lg-12">		  
			
		  <div class="decd">
		  	<div class="new_bt">			
        <form action="<?php echo base_url();?>employees/ImportEmployeecsv" method="post" enctype="multipart/form-data"><input type="submit"  title="Import employee list for initial setup" name="submit" value="Import list" />
  ...
  <!--div class="view_sece">
    ...
    margin-right: 4px;    margin-left: -2px;    margin-top: 5px;    float: left;" 
		  ...
		  <div class="col-lg-1">
				...
				{
					?>
			<form  method="post" action="employees/ImportEmployeecsv" enctype="multipart/form-data">
    ...
    left: 20%;" class="data-1" method="post" action="employees/multiple_file" enctype="multipart/form-data">
    <div class="form-group">
        <input type="submit" name="fileSubmit"  title="Click Here To Import Employee Selected Data" value="Import Employee Data"/>   
    ...
    position: absolute;
    right: 0px;"class="multiple-22" method="post" action="employees/multiple_sign_upload" enctype="multipart/form-data">
    <div class="form-group">
                ...
                <div class="wrapper wrapper-content animated fadeInDown">
                    <div class="ibox-content">
						...
						<div class="col-md-1" style="float: right; margin-right: 0px;"><div class="my-slect">
                            ...
                            <?php } ?>  </select></div></div>
							<div class="col-md-1" style="float: right; margin-right: 0px;"><div class="my-slect">
							 <select name="rem-day-filter" id="rem-day-filter" class="form-control required">
...
<div class="col-md-1" style="float: right; width:100px; margin-right: 0px;"><div class="my-slect">
 ...
 <thead><tr> <th class="text-center"><label><input type="checkbox" name="checkHead" class="i-checks checkHead" id="selectall"/>
										...
										<th style="width:50px!important;">	<img title="You Can Reset All Employee Confirmed Date From Here" class="reset_con" style=" vertical-align: top; width: 18px;    margin-right:4px;    margin-left: 3px;    margin-top: 0px;    float: left;" 
										 ...
										 <th style="width:50px!important;">W-days</th>
