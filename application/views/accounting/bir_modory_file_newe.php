    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= $this->lang->line('Employee Benefit (Modory) Registration') ?></h4>
            </div>
            <div class="modal-body">
                <form action="accounting/save_bir_modory_filee" method="POST" id="save_bir_file">
                    <div id="save_result2"></div>
                    <input type="hidden" id="bir_m_file_id" name="bir_m_file_id" value="0" class="bir_file_id">
