...
<div id="wrapper">
    <?php $this->load->view('layout/menu',array('active_menu'=>'bir_egate_filesE'))?>
    <div id="page-wrapper" class="gray-bg">
        <?php $this->load->view('layout/page_header')?>
        
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                <h2><?= $this->lang->line('Employee Benefit ( Egate )')?></h2>
                <ol class="breadcrumb">
                    <li>
            ...
            <div class="col-lg-4">
                <div class="title-action">
                    <a href="accounting/new_bir_egate_filee" class="btn btn-primary" data-target="#modal_window" data-toggle="modal">
                                ...
                                <table class="table table-striped table-bordered table-hover data_table" id="table">
                                    ...
                                    <tbody style="text-align: center;">
										...
										?>	
                                            ...
                                            <td>
                                                <a class="btn btn-outline btn-success" href="accounting/edit_bir_egate_filee/<?= $bir_file['bir_e_file_id']?>" data-target="#modal_window" data-toggle="modal">
...
//alert(letter);
   // var iddd = $("#mySelectorr1").html(data);
		 ...
		 $.ajax({
        type: "GET",
        url: 'accounting/updatealertegatee/?',
        data:letter,
        success: function(data) {
