...
<div id="wrapper">
    <?php $this->load->view('layout/menu',array('active_menu'=>'bir_calender_filesE'))?>
    <div id="page-wrapper" class="gray-bg">
        <?php $this->load->view('layout/page_header')?>
        
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                <h2><?= $this->lang->line('Employee Benefit ( Uplus )')?></h2>
                <ol class="breadcrumb">
                    <li>
            ...
            <div class="col-lg-4">
                <div class="title-action">
                    <a href="accounting/new_bir_calender_filee" class="btn btn-primary" data-target="#modal_window" data-toggle="modal">
                                ...
                                <table class="table table-striped table-bordered table-hover data_table" id="table">
                                    ...
                                    <tbody style="text-align: center;">
										...
										<?php
											...
											$type = 'bir_calander_filee';
											$this->load->model('accounting_actions');
											$bir_attach = $this->accounting_actions->get_bir_file_attach($bir_file_id, $type);
											//echo "<pre>";
											//print_R($bir_attach);
										?>	
                                            <td><a href="<?= (!isset($base_url)?'employees':$base_url)?>/download_attachment/<?= $bir_attach['attachment_id']?>" target="_blank"><?php echo $bir_attach['file'] ?></a></td>
											<?php 
										...
										?>	
                                            ...
                                            <td>
                                                <a class="btn btn-outline btn-success" href="accounting/edit_bir_calnder_filee/<?= $bir_file['bir_c_file_id']?>" data-target="#modal_window" data-toggle="modal">
