...
class Accounting extends CI_Controller {
	...
	function bir_modory_filesE() {  
        ...
        $this->load->model('accounting_actions');
		$bir_forems = $this->accounting_actions->get_bir_formsb();
		$list = $this->array_sortt($bir_forems, 'form_name', SORT_DESC);
	    $this->load->view('accounting/bir_modory_filesE',array('bir_files' => $this->accounting_actions->get_bir_modory_files(),'bir_forems' => $list));
