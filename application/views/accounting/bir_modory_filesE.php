                                ...
                                <table class="table table-striped table-bordered table-hover data_table" id="table">
                                    ...
                                    <tbody style="text-align: center;">
										...
										?>	
                                            ...
                                            <td>
                                                <a class="btn btn-outline btn-success" href="accounting/edit_bir_modory_filee/<?= $bir_file['bir_m_file_id']?>" data-target="#modal_window" data-toggle="modal">
...
$('td #mySelectorr').click( function(e) { 
 ...
 // alert(letter);
   // var iddd = $("#mySelectorr1").html(data);
		 ...
		 $.ajax({
        type: "GET",
        url: 'accounting/updatealertmodorye/?',
        data:letter,
        success: function(data) {
