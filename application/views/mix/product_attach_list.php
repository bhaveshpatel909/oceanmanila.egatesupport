<div id="attachments_list">
    ...
    <div class="file m-b-xs" id="attachment_<?= $attachment['attachment_id']?>">
        ...
        <?php }?>
        <div class="file-name">
		<div><a class='preview ' target="_blank" href="<?php echo base_url('files/attachments/ProductImages/' . $attachment['location']) ?>"download="<?php echo base_url('files/attachments/ProductImages/' . $attachment['location']) ?>" target="_blank"><i class="fa <?= get_fa_extension($attachment['extenstion']) ?>"></i> <?= $attachment['file'] ?></a></div>
