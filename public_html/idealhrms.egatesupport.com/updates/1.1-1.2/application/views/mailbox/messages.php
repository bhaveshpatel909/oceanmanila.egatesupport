...
<div class="feed-element" id="message_<?= $message['message_id']?>">
    ...
    <div class="media-body ">
        ...
        <p><?= $message['message']?></p>
        <?php if (!is_null($message['attachments']))
        {
            $this->load->view('mix/attachments_list',array('readonly'=>TRUE,'attachments'=>json_decode('['.$message['attachments'].']',TRUE),'base_url'=>'profile'));
        }?>
    </div>
</div>
<?php }?>