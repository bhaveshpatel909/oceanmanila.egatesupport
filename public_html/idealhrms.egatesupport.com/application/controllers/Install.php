<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
  ...
  class Install extends CI_Controller
  {
      ...
      function index()
      {
         ...
         {
             exit($this->load->view('layout/success_page',array('message'=>'<h3 class="font-bold">'.$this->lang->line('Application already installed.').'</h3> <br/><a class="btn btn-primary m-t" href="'.$this->config->item('base_url').'">'.$this->lang->line('Go to application').'</a>'),TRUE));
         }
