...
<script>
	...
	function msend(id){
            ...
            type: 'post',
			cache: false,
            url: 'http://uplushrms.peza.com.ph/discipline/send_mail/'+id,
           data : 'mid='+ id,
...
<div class="ibox-content no-padding border-left-right text-center" title="Picture should be lasted Photo with good resulution . It will also used for company ID Picture , Do not use picture from resume.  Take picture using phone application.">                            
                                            <img class="avatar img-rounded" src="<?= $employee['avatar'] ?>" style="width: 140px;height: 140px; margin: 20px 0;" data-toggle="modal" data-target="#myModal">
...
<div class="ibox-content no-padding border-left-right text-center" title="Picture should be lasted Photo with good resulution . It will also used for company ID Picture , Do not use picture from resume.  Take picture using phone application.">    
                                            ...
                                            <img class="avatar img-rounded" src="<?= $employee['sign'] ?>" style="width: 140px;height: 140px; margin: 20px 0;" data-toggle="modal" data-target="#myModal111">
											  ...
											  <img src="images/if_Help.png" width="13%">
											  <?php } ?>
                                            <!-- imgSelect Container -->
...
<input class="form-control ghghghh" type="text" value="<?= $days ?>">
								...
								<div class="ibox-title dddd nes">
									...
									<div class="row">
										...
										<?php
											...
											<h3 style=""><span title="Work Evaluation" class="green_bg"><?= $count;?></span>Work Evaluation <img src="images/if_Help.png" title="Quit Claim , Incentives , Penalty. Etc" style="width:17px; cursor:pointer;"> </h3>
			...
			<a target="_blank" title="preview" type="application/pdf" class="btn btn-outline btn-primary btn-xs" href="evaluation/preview_evaluation/<?= $evaluation['evaluation_id']?>" download="<?php echo base_url('files/attachments/' . $attachment['file']) ?>" target="_blank">
									...
									<div class="ibox-title  ibox_title22233 ibox_title222">
										...
										<?php }else {?>  
											<h3 style=""><span  title="Disciplinary Warning" class="green_bg"><?= $displain;?></span>Disciplinary Action </h3>
										<?php } ?>
										</div>
										<div class="col-lg-6">
...
<i style='color: red;cursor: pointer;' title="<?php echo $attachment['file'];?>" class="fa fa-file-pdf-o"> &nbsp;</a></i>
							  <?php  } }?>
								...
								<a class="btn btn-outline btn-primary btn-xs" href="javascript:void(0);" onclick="msend(<?php echo $evaluation['record_id'];?>)">
									...
									<table class="table table-striped table-bordered table-hover data_table" >
										...
										<h3 style="font-weight:bold;clear:both;" ><span class="green_bg"><p title="Approved Leave"><?= $get_leave?> / <p style="color:red" title="Request Leave"><?= $get_leave2?></p></span><?= $this->lang->line('Leave Tracking')?></h3>
										</div>
										</div>
											<tr>
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-title " id="employees_contract_click">
                                    <h5><?= $this->lang->line('Contract & Resignation') ?></h5>
                                </div>
