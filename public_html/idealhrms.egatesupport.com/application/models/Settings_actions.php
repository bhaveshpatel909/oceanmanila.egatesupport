...
class Settings_actions extends Base_model {
   ...
   function get_managersettings() {
        ...
        $result = $this->db
                ->select('setting_value')
                ->where(array('setting_key' => 'company_email_second'))
                ->get('settings')
                ->row_array();
        return $result;
	...
	function get_accountingmail_settings() {
	...
	function get_employee_settings() {
        
        $result = $this->db
                ->select('setting_value')
                ->where(array('setting_key' => 'no_of_employee'))
                ->get('settings')
                ->row_array();
        return $result;
	...
	function get_taskmanagergmail_settings() {
 ...
 function save_settingss($admin_email1,$task_manager_email1,$accounting_email,$admin_manager_name,$company_address,$company_name,$company_phone,$no_employee,$expire_date) {
		 ...
		 $this->db->update('settings', array('setting_value' => $accounting_email), array('setting_key' => 'accounting_email'));
		 $this->db->update('settings', array('setting_value' => $admin_manager_name), array('setting_key' => 'admin_manager_name'));
		 $this->db->update('settings', array('setting_value' => $company_name), array('setting_key' => 'company_name'));
		 $this->db->update('settings', array('setting_value' => $company_phone), array('setting_key' => 'company_phone'));
		 $this->db->update('settings', array('setting_value' => $company_address), array('setting_key' => 'company_address'));
		 $this->db->update('settings', array('setting_value' => $no_employee), array('setting_key' => 'no_of_employee'));
		 $this->db->update('settings', array('setting_value' => $expire_date), array('setting_key' => 'expire_date'));
