<?php
  ...
  {
      function get_grouped_departments()
      {
          ...
          {
              $result[$department['department_id']]['name']=$department['department_name'];
              $result[$department['department_id']]['departments'][]=$department;
          }
      ...
      {
          return $this->db
                      ->select('department_id,department_name,IFNULL(department_name,"-") as department_name',FALSE)
                      ->where('is_active',1)
      ...
      {          
          ...
          {
              $this->db->update('departments',$data,array('department_id'=>$this->input->post('department_id')));
