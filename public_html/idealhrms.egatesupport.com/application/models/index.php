                            ...
                            <table class="table table-striped table-bordered table-hover data_table" id="employee_grid">
                                ...
                                <tbody>
									...
									$grest = substr($petty_cash['created_date'], 5, -3);
										...
										<td style="width:10%important;" id="writememo" data-pid="<?= $petty_cash['petty_cash_id'] ?>" data-pc="<?= $petty_cash['comment_p'] ?>"><a class="btn btn-outline btn-success btn-xs" href="javascript:void(0);">
                                                        <i class="fa fa-edit"></i>
                                                    </a></td>
                                        </tr>                                    
                                    <?php } ?>
