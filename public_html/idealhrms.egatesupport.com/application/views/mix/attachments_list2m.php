<div id="attachments_list2">
    ...
    <div class="file m-b-xs">
        ...
        <div class="file-name">
            ...
            <input type="file" multiple="multiple" name="new_attachments2m[]" id="new_attachments2">
    ...
    <div class="file m-b-xs" id="attachment_<?= $attachment2['attachment_id']?>">
        ...
        <div class="file-name">
            ...
            <a href="<?= (!isset($base_url)?'employees':$base_url)?>/download_attachment/<?= $attachment2['attachment_id']?>" target="_blank">
