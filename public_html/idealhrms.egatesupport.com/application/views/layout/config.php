...
|
*/
$config['base_url']    = 'http://wshrms.peza.com.ph/';
...
$config['possible_permissions']=array('Employees','Reminder','Performance','Employee Request','Master List','accounting','reports','documents','evaluations','schedule','tasks','letter','Edit_Calandare_Schedule','leave_tracking','Work Manual');
