    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="discipline/delete_discipline_action" method="POST" id="delete_discipline_action">
                    <input type="hidden" id="discipline_action_id" name="discipline_action_id" value="<?= $discipline_action['id'] ?>" class="discipline_action_id">
                </form>
                <form action="discipline/save_discipline_action" method="POST" id="save_discipline_action">
                    ...
                    <div class="col-lg-6" style="padding-left: 0;">
                        <div class="form-group has-feedback m-t-sm">
                            ...
                            <input type="text" name="discipline_action_name" id="discipline_action_name" class="form-control required" maxlength="100" value="<?= $discipline_action['name'] ?>">
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger pull-left" onclick="confirm('Delete discipline_action ?') && submit_form('#delete_discipline_action', '#save_result2')"><?= $this->lang->line('Delete') ?></button>
