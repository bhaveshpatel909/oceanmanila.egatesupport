...
<div id="wrapper">
    <?php $this->load->view('layout/menu',array('active_menu'=>'discipline_category'))?>
    <div id="page-wrapper" class="gray-bg">
        <?php $this->load->view('layout/page_header')?>
        
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                <h2><?= $this->lang->line('201 File Category')?></h2>
                <ol class="breadcrumb">
                    <li>
            ...
            <div class="col-lg-4">
                <div class="title-action">
                    <a href="discipline/new_discipline_category"  class="btn btn-primary" data-target="#modal_window" data-toggle="modal">
                ...
                <div class="wrapper wrapper-content animated fadeInDown">
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <table style="border-top:1px #ddd solid !important;" class="table table-striped table-bordered table-hover data_table" >
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr entity_id="<?= $discipline_action['id']?>">
                                        ...
                                        <td>
                                            <a class="btn btn-outline btn-success" data-target="#modal_window" data-toggle="modal" href="discipline/edit_discipline_category/<?= $discipline_action['id']?>">
