...
td.secnd22 .badge {    border-radius: 0px;    margin-left: 0px !important;}
td.secnd22 {
                                        ...
                                        <tr entity_id="<?= $task['task_id'] ?>" class="<?php echo $processclass;?>">
											...
											<div style=" position:relative;">
												<?php if($task['task_attention']=="updated"){?>
										         <b><img src="http://uplushrms.peza.com.ph/images/if_check.png "style="width:13px; height:13px"></b><?php }?>
												<?php if($task['task_attention']=="required"){?>
										      <b><img src="http://uplushrms.peza.com.ph/images/if_question.png"style="width:13px; height:13px"></b><?php }?>
												<?php 
											 $cday = $settingss['days'];
