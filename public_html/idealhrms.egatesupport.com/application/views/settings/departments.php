...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                <h2><?= $this->lang->line('Departments')?><span><img title="-You may add specific division  or department where you can easily select where the employee belongs"style="margin-left:5px;" src="images/if_Help.png" width="17px"></span></h2>
                <ol class="breadcrumb">
                    <li>
