<?php if (is_numeric($result)){
    ...
    <script>
        $('document').ready(function(){
            row = current_table.fnAddData([$("#department_name").val(),'<a href="settings/edit_group/<?= $result?>" data-target="#modal_window" data-toggle="modal" class="btn btn-outline btn-success"><i class="fa fa-edit"></i></a>']);
