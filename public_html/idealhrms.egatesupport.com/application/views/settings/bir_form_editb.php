...
$('.delete_bir_form').click(function(){
			var  burl ="<?php echo base_url();?>";
		location.href=burl+"settings/bir_formsb";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= $this->lang->line('Employee Benefit Registration') ?></h4>
            </div>
            <div class="modal-body">
                <form action="settings/delete_bir_formb" method="POST" id="delete_bir_form">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger pull-left delete_bir_form" onclick="confirm('Delete Bir Form ?') && submit_form('#delete_bir_form', '#save_result2')"><?= $this->lang->line('Delete') ?></button>
