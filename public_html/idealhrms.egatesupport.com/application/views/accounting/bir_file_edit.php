    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= $this->lang->line('BIR Form Update Form') ?></h4>
            </div>
            <div class="modal-body">
                <form action="accounting/delete_bir_file" method="POST" id="delete_bir_file">
                    <input type="hidden" id="bir_file_id" name="bir_file_id" value="<?= $bir_file['bir_file_id'] ?>" class="bir_file_id">
                </form>
                <form action="accounting/save_bir_file" method="POST" id="save_bir_file">
                    ...
                    <div class="col-lg-6" style="padding-left: 0;">
                        <div class="form-group has-feedback m-t-sm">
                            <label for="amount" class="control-label"><?= $this->lang->line('Amount to Pay') ?><sup class="mandatory">*</sup></label>
                            <input type="text" name="amount" id="amount" value="<?= $bir_file['amount']?>"  class="form-control required" maxlength="12">
                        </div>
                    </div>
					
					<div class="form-group has-feedback col-lg-6" style="padding-left: 10px;padding-right:0px">
                        <label for="form_id" class="control-label m-t-sm"><?= $this->lang->line('Payment Proof') ?></label>
