<?php if (is_numeric($result)){
    ...
    <script>
        $('document').ready(function(){
            row = current_table.fnAddData([$("#for_themonth").val(),$('#form_id option:selected').text(),null,$("#alertchk").val(),$("#amount").val(),null,null,null,'<a href="accounting/edit_bir_egate_file/<?= $result?>" data-target="#modal_window" data-toggle="modal" class="btn btn-outline btn-success"><i class="fa fa-edit"></i></a>']);
