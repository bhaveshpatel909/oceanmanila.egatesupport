    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= $this->lang->line('Employee Benefit bir  Update Form') ?></h4>
            </div>
            <div class="modal-body">
                <form action="accounting/delete_bir_modory_filee" method="POST" id="delete_bir_file">
                    <input type="hidden" id="bir_m_file_id" name="bir_m_file_id" value="<?= $bir_file['bir_m_file_id'] ?>" class="bir_file_id">
                </form>
                <form action="accounting/save_bir_modory_filee" method="POST" id="save_bir_file">
