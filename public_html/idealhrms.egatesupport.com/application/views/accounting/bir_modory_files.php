...
<div id="wrapper">
    <?php $this->load->view('layout/menu',array('active_menu'=>'bir_modory_files'))?>
    <div id="page-wrapper" class="gray-bg">
        <?php $this->load->view('layout/page_header')?>
        
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                <h2><?= $this->lang->line('BIR file ( Modory )')?></h2>
                <ol class="breadcrumb">
                    <li>
            ...
            <div class="col-lg-4">
                <div class="title-action">
                    <a href="accounting/new_bir_modory_file" class="btn btn-primary" data-target="#modal_window" data-toggle="modal">
