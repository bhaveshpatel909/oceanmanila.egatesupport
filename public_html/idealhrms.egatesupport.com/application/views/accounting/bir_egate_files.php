<?php $this->load->view('layout/header',array('title'=>$this->lang->line('BIR file ( Egate )'),'forms'=>TRUE,'tables'=>TRUE,'icheck'=>TRUE)) ?>
<script>
...
<div id="wrapper">
    <?php $this->load->view('layout/menu',array('active_menu'=>'bir_egate_files'))?>
    <div id="page-wrapper" class="gray-bg">
        <?php $this->load->view('layout/page_header')?>
        
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                <h2><?= $this->lang->line('BIR file ( Egate )')?></h2>
                <ol class="breadcrumb">
                    <li>
            ...
            <div class="col-lg-4">
                <div class="title-action">
                    <a href="accounting/new_bir_egate_file" class="btn btn-primary" data-target="#modal_window" data-toggle="modal">
                            ...
                            <div id="save_result"></div>
                                <table class=" sustmclas table table-striped table-bordered table-hover data_table" id="table">
                                    ...
                                    <tbody style="text-align: center;">
                                        ...
                                        <tr entity_id="<?= $bir_file['bir_e_file_id']?>" class="eachro">
                                            <td><?= $bir_file['for_themonth']?></td>
                                            <td class="col2"><?= $bir_file['form_name']?></td>
										<?php
										
										
											$bir_file_id = $bir_file['bir_e_file_id'];
											$type = 'bir_egate_file';
										...
										?>	
											...
											<td class="xyz">
												...
												<input type="checkbox" style="width: 109px; height: 21px;" <? if($bir_file['alertchk']== 1){ ?> checked <?php } ?> name="alertchk" id="mySelectorr"  value="<? echo 'check='. $bir_file['alertchk'];echo '&formid='.$bir_file['bir_e_file_id'];
                                            ...
                                            <td>
                                                <a class="btn btn-outline btn-success" href="accounting/edit_bir_egate_file/<?= $bir_file['bir_e_file_id']?>" data-target="#modal_window" data-toggle="modal">
...
$('td #mySelectorr').click( function(e) { 
 ...
 // alert(letter);
   // var iddd = $("#mySelectorr1").html(data);
		 ...
		 $.ajax({
        type: "GET",
        url: 'accounting/updatealertegate/?',
        data:letter,
        success: function(data) {
