    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= $this->lang->line('Add Vendor list') ?></h4>
            </div>
                ...
                <form action="vendorlist/save_vendorlist" method="POST" id="save_task_type">
                    ...
                    <div class="col-lg-12" style="padding-left: 0;">
                        <div class="form-group has-feedback m-t-sm">
                            ...
                            <input type="text" name="vendor_name" id="bank_name" class="form-control required" maxlength="50">
                        </div>
						<div class="form-group has-feedback m-t-sm">
                            <label for="account_no" class="control-label"><?= $this->lang->line('Contact Info') ?><sup class="mandatory">*</sup></label>
                            <input type="number" name="contactinfo" id="account_no" class="form-control required" maxlength="50">
                        </div>
						<div class="form-group has-feedback m-t-sm">
