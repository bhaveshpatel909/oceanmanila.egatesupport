...
<div class="pdf-wrapper">
    <div class="pdf-header">
		...
		<div class="pull-left" style="float: right;width: 20%;">
      <img class="images" src="<?php echo $contract['imp_img'] ?>"/>
    ...
    <div class="pdf-content">
        ...
        <p>
			...
			<strong>Performance Allowance : </strong> <?php echo ($contract['performance_allowance']) ?><br>
