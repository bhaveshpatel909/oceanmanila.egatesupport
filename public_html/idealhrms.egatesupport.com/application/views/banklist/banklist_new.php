    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= $this->lang->line('Add Bank list') ?></h4>
            </div>
                ...
                <form action="banklist/save_banklist" method="POST" id="save_task_type">
                    ...
                    <div class="col-lg-12" style="padding-left: 0;">
                        <div class="form-group has-feedback m-t-sm">
                            ...
                            <input type="text" name="bank_name" id="bank_name" class="form-control required" maxlength="50">
                        </div>
						<div class="form-group has-feedback m-t-sm">
                            <label for="account_no" class="control-label"><?= $this->lang->line('Account Number') ?><sup class="mandatory">*</sup></label>
                            <input type="number" name="account_no" id="account_no" class="form-control required" maxlength="50">
                        </div>
						<div class="form-group has-feedback m-t-sm">
                            <label for="contact_no" class="control-label"><?= $this->lang->line('Phone# & Contact') ?><sup class="mandatory">*</sup></label>
                            <input type="number" name="contact_no" id="contact_no" class="form-control required" maxlength="50">
                        </div>
                    </div>
