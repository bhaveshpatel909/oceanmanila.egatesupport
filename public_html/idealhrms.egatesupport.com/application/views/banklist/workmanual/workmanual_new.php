    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= $this->lang->line('New WorkManual') ?></h4>
            </div>
            <div class="modal-body">
                <div id="save_result2"></div>
                <form action="workmanual/update_workmanual" method="POST" id="save_document">
				<?php 
				// echo '<pre>';
				// print_r($_GET['cat']);
				// echo '</pre>';
...
<!--                        <label class="control-label" for="document"><?= $this->lang->line('Document') ?><sup class="mandatory">*</sup></label>
                    ...
                    <div class="form-group">
						...
						?>
                         ...
                         <select name="workmanual_category_id" id="workmanual_category_id" class="form-control required">
                            <option value="">Select</option>
                            <?php foreach ($deparment as $category) { ?>
                                <option <?php echo ($category_id == $category['department_id'])? 'selected' : ''?> value="<?= $category['department_id'] ?>"><?= $category['department_name'] ?></option>
                            <?php } ?>
                        </select>
						<?php }
						else {
						...
						?>
						  <input type="text" name="workmanual_category_id" value="<?php echo $catss;?> " readonly id="workmanual_category_id" class="form-control required" />
                   <?php } ?>
                    </div>
                    <div class="form-group">
