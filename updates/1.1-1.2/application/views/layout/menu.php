<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li <?= (in_array($active_menu,array('employees','employees_new')))?'class="active"':''?>>
                <a href="employees">
                    <i class="fa fa-users"></i>
            ...
            <li <?= (in_array($active_menu,array('documents')))?'class="active"':''?>>
                <a href="documents">
            ...
            <li <?= (in_array($active_menu,array('company_settings','company_email','company_positions','resign_reasons','departments','processing_errors','unsent_emails')))?'class="active"':''?>>
